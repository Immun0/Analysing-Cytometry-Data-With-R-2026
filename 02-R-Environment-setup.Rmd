...
```{r install-r-step-1, echo=FALSE, fig.cap="Download the correct R version for your operating system", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "Install_R_Step_1.png"))
```

```{r install-r-step-4, echo=FALSE, fig.cap="Download the latest version of R. The version you download may be higher than the one pictured", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "Install_R_Step_4.png"))
```
...
```{r use-r, echo=FALSE, fig.cap="The base R interface is basic but functional", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "Use_R.png"))
```
...
```{r install-rstudio, echo=FALSE, fig.cap="There are several RStudio versions, the free Desktop version is the one we need", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "InstallRStudio.gif"))
```
...
```{r rstudio-overview, echo=FALSE, fig.cap="What RStudio looks like when it's set up and running", out.width="100%", fig.align='center'}
...
```{r rstudio-panes-overview, echo=FALSE, fig.cap="The four main panes: Console/Terminal/Jobs, Source, Environment, and Files/Plots/Help/Viewer", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioConsoleZoom.gif"))
```
...
```{r rstudio-console, echo=FALSE, fig.cap="The console works exactly like the base R interface you tested earlier", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioConsole.gif"))
```
...
```{r rstudio-terminal, echo=FALSE, fig.cap="The Terminal tab gives access to your system shell without leaving RStudio", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioPanesTerminal.gif"))
```
...
```{r rstudio-jobs, echo=FALSE, fig.cap="The Jobs tab lets you run scripts in the background", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioPanesJobs.gif"))
```
...
```{r rstudio-environment, echo=FALSE, fig.cap="As you create variables and load data, they appear here with basic info about each one", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioEnvironmentPaneEnvironment.gif"))
```
...
```{r rstudio-files, echo=FALSE, fig.cap="The Files tab works like a standard file browser", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioFilesPaneFiles.gif"))
```

- **Plots:** Where graphs will appear when you create them

```{r rstudio-plots, echo=FALSE, fig.cap="The Plots tab shows every plot you generate; scroll through multiple plots with the arrow icons", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioConsolePanePlots.gif"))
```

- **Help:** Where documentation appears when you ask for help (`?functionname` or `??keyword`)

```{r rstudio-help, echo=FALSE, fig.cap="The Help tab shows package documentation and vignettes", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioFilesPaneHelp.gif"))
```

- **Viewer:** Displays local web-compatible content, tables, interactive plots, and similar

```{r rstudio-viewer, echo=FALSE, fig.cap="The Viewer tab displays local web-compatible output like interactive tables", out.width="100%", fig.align='center'}
knitr::include_graphics(here::here("Images", "RStudioFilesPanelViewer.gif"))
```
