...
```{r require-vs-library, eval=FALSE}
...
```{r package-structure, fig.align='center', fig.cap="On your computer, a package is just an organised set of files and folders", echo=FALSE, warning=FALSE}
knitr::include_graphics(here::here("Images", "SourcePackageStructure.PNG"))
```

### Managing Your Package Library

**Check what's installed:**
```{r check-installed, eval=FALSE}
installed.packages()
```
...
**Remove a package:**
```{r remove-package, eval=FALSE}
remove.packages("packagename")
```

**Find package information:**
```{r package-info, eval=FALSE}
